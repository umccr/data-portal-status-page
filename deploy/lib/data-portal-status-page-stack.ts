...
export class DataPortalStatusPageStack extends cdk.Stack {
  constructor(scope: Construct, id: string, props?: cdk.StackProps) {
    ...
    const hostedZoneId = ssm.StringParameter.valueForStringParameter(this, '/hosted_zone/umccr/id');
    ...
    const clientBucket = new s3.Bucket(this, 'data-portal-status-page-client-bucket', {
    ...
    const cloudfrontOai = new cloudfront.OriginAccessIdentity(this, 'umccr-script-oai', {
    ...
    const dataPortalStatusPageCloudfront = new cloudfront.CloudFrontWebDistribution(
      this,
      'cloud_front_name',
      {
