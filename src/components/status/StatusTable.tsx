...
function StatusTable(props: any) {
  ...
  // Sorting Table
  const [order, setOrder] = useState<TableSortLabelOwnProps['direction']>('asc');
  ...
  return (
    <TableContainer sx={{ textAlign: 'center', margin: '1em 0 2em', position: 'relative' }}>
      {noTitle ? (
        <></>
      ) : (
        <Typography sx={{ margin: '0 0 1em 0' }} variant='h6' gutterBottom component='div'>
